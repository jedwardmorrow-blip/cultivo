...
export function BerlinLandingPage() {
 ...
 style={{
 backgroundImage: `url("data:image/svg+xml,%3Csvg viewBox='0 0200200'xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='n'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.65' numOctaves='3' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23n)'/%3E%3C/svg%3E")`,
 }}
 />
 ...
 {/* ── Nav ── */}
 <nav className="sticky top-0 z-50 border-b border-cult-border bg-cult-surface/90">
 ...
 <span className="text-xs font-bold text-cult-danger tracking-[0.25em] uppercase bg-cult-opaque-black/90 px-5 py-2 border border-cult-danger/30 shadow-[0_0_20px_rgba(220,69,69,0.1)]">
 Replaced
 </span>
 </div>
 </div>
