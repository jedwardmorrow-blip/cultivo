...
export function AuditReviewApply({
 ...
 <div className="rounded-cult border border-cult-success/30 bg-cult-success/10 p-4">
 ...
 {isAbandoned && (
 <div className="rounded-cult border border-cult-border bg-cult-surface-subtle p-4">
 ...
 {/* Error banner */}
 {error && !isTerminal && (
 <div className="rounded-cult border border-cult-danger/30 bg-cult-danger/10 p-4">
 <div className="flex items-center gap-2">
 ...
 {/* Net variance */}
 <div className="rounded-cult border border-cult-border bg-cult-surface-raised p-4 flex items-center justify-between">
 ...
 <div className="rounded-cult border border-cult-warning/30 bg-cult-warning/10 p-3 text-sm text-cult-warning">
 ...
 className="px-4 py-2 rounded-cult border border-cult-danger/30 text-cult-danger text-sm font-bold hover:bg-cult-danger/10 transition"
 >
 Abandon Audit
 </button>
 <button
 ...
 className="px-6 py-2 rounded border border-cult-accent text-cult-accent hover:bg-cult-accent hover:text-cult-opaque-black transition-colors disabled:opacity-40 disabled:cursor-not-allowed flex items-center gap-2 font-mono uppercase tracking-[0.16em] text-[11px]"
 >
 ...
 type="button"
 onClick={onBackToHub}
 className="px-5 py-2.5 rounded-cult border border-cult-border text-cult-text-secondary font-medium text-sm hover:bg-cult-surface-raised transition"
 >
 Back to Audit Hub
 </button>
 </div>
 ...
 <div className="absolute inset-0 bg-black/70" onClick={() => setAbandonOpen(false)} />
 <div className="relative w-full max-w-sm rounded-cult border border-cult-border bg-cult-surface p-6">
 ...
 className="w-full px-3 py-2 rounded-cult border border-cult-border bg-cult-surface-subtle text-sm text-cult-text-primary placeholder:text-cult-text-muted resize-none focus:outline-none focus:border-cult-accent/50 mb-4"
 />
 ...
 className="px-5 py-2 rounded-cult bg-cult-danger text-white font-bold text-sm hover:bg-cult-danger/80 transition disabled:opacity-40 flex items-center gap-2"
 >
 {actionLoading && <Loader2 className="w-4 h-4 animate-spin" />}
 Abandon
 </button>
...
function StatCard({ label, value, color }: { label: string; value: number; color: string }) {
 return (
 <div className="rounded-cult border border-cult-border bg-cult-surface-raised p-3 text-center">
...
function ConfirmModal({
 ...
 onClick={onConfirm}
 disabled={loading}
 className="px-5 py-2 rounded border border-cult-accent text-cult-accent hover:bg-cult-accent hover:text-cult-opaque-black transition-colors disabled:opacity-40 flex items-center gap-2 font-mono uppercase tracking-[0.16em] text-[11px]"
 >
