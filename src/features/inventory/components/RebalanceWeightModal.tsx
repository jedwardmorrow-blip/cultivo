...
export function RebalanceWeightModal({ isOpen, sourceItem, allItems, onClose, onComplete }: RebalanceWeightModalProps) {
 ...
 <div className="bg-cult-surface border border-cult-border rounded-cult w-full max-w-2xl max-h-[90vh] flex flex-col">
 <div className="flex items-center justify-between px-6 py-4 border-b border-cult-border">
 <h2 className="text-lg font-semibold text-cult-text-primary">Rebalance Weight</h2>
 <button onClick={handleClose} disabled={saving} className="text-cult-text-muted hover:text-cult-text-primary disabled:opacity-50">
 <X className="w-5 h-5" />
 </button>
 </div>
 ...
 <div className="text-xs uppercase tracking-wider text-cult-text-muted mb-2">Source</div>
 <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
 <div>
 <span className="text-xs text-cult-text-muted">Package ID</span>
 <div className="font-mono text-sm font-medium text-cult-text-primary">{sourceItem.package_id}</div>
 </div>
 <div>
 <span className="text-xs text-cult-text-muted">Current Qty</span>
 <div className="text-sm font-semibold text-cult-text-primary tabular-nums">
 {sourceQty.toFixed(sourceUnit === 'g' ? 1 : 0)} {sourceUnit}
 </div>
 </div>
 <div>
 <span className="text-xs text-cult-text-muted">Product</span>
 <div className="text-sm text-cult-text-secondary">{sourceItem.product_name || '-'}</div>
 </div>
 <div>
 <span className="text-xs text-cult-text-muted">Strain</span>
 <div className="text-sm text-cult-text-secondary">{sourceItem.strain || '-'}</div>
 </div>
 </div>
 </div>

 <div>
 <label className="block text-sm font-medium text-cult-text-secondary mb-2">Destination Package</label>
 ...
 className="w-full pl-9 pr-4 py-2 bg-cult-surface border border-cult-border rounded-lg text-sm text-cult-text-primary placeholder-cult-text-muted focus:outline-none focus:border-cult-text-secondary"
 />
 </div>
 <div className="max-h-40 overflow-y-auto rounded-lg border border-cult-border bg-cult-surface">
 {filteredDest.length === 0 ? (
 <div className="p-4 text-center text-sm text-cult-text-muted">No eligible items found</div>
 ) : (
 ...
 : 'text-cult-text-secondary hover:bg-cult-border/40 hover:text-cult-text-primary'
 }`}
 >
 <span className="flex items-center gap-3 min-w-0">
 <span className="font-mono font-medium truncate">{item.package_id}</span>
 <span className="text-cult-text-muted truncate">{item.strain || ''}</span>
 </span>
 ...
 disabled={saving}
 className="flex-1 px-4 py-2 bg-cult-surface border border-cult-border rounded-lg text-sm text-cult-text-primary focus:outline-none focus:border-cult-text-secondary disabled:opacity-50"
 placeholder="0"
 />
 <span className="text-sm text-cult-text-muted">{sourceUnit}</span>
 </div>
 ...
 {isQtyValid && destItem && (
 <div className="grid grid-cols-[1fr_auto_1fr] items-center gap-3 p-4 rounded-lg bg-cult-surface border border-cult-border">
 <div className="text-center">
 <div className="text-xs text-cult-text-muted mb-1">Source After</div>
 <div className="text-lg font-bold text-cult-text-primary tabular-nums">
 {sourceAfter.toFixed(sourceUnit === 'g' ? 1 : 0)}
 </div>
 <div className="text-xs text-cult-danger tabular-nums">-{qty.toFixed(sourceUnit === 'g' ? 1 : 0)}</div>
 </div>
 <ArrowRight className="w-5 h-5 text-cult-text-muted" />
 <div className="text-center">
 <div className="text-xs text-cult-text-muted mb-1">Dest After</div>
 <div className="text-lg font-bold text-cult-text-primary tabular-nums">
 ...
 disabled={saving}
 className="w-full px-4 py-2 bg-cult-surface border border-cult-border rounded-lg text-sm text-cult-text-primary focus:outline-none focus:border-cult-text-secondary disabled:opacity-50"
 >
 ...
 <div>
 <label className="block text-sm font-medium text-cult-text-secondary mb-2">Notes</label>
 <textarea
 value={notes}
 ...
 className="w-full px-4 py-2 bg-cult-surface border border-cult-border rounded-lg text-sm text-cult-text-primary placeholder-cult-text-muted focus:outline-none focus:border-cult-text-secondary disabled:opacity-50 resize-none"
 />
 </div>
