...
export function CoaDrawer({ batchId, onClose, onBatchClick }: CoaDrawerProps) {
 ...
 className="p-2 rounded-cult hover:bg-cult-surface-overlay transition-colors text-white/40 hover:text-white/70"
 >
 <X className="w-5 h-5" />
 </button>
 </div>
 ...
 <div key={i} className="h-20 rounded-cult bg-cult-surface animate-pulse" />
 ))}
 </div>
 ) : coa ? (
 <>
 ...
 className="flex items-center gap-2 mt-2 bg-cult-surface rounded-cult p-3 border border-cult-border-subtle hover:bg-cult-surface-overlay hover:border-cult-border transition-all"
 >
...
function CannabinoidPanel({ coa }: { coa: CoaRecord }) {
 ...
 <div className="rounded-cult bg-cult-surface-inset border border-cult-border-faint p-4 mt-2 text-center">
 ...
 <div className="bg-cult-surface rounded-cult p-4 border border-cult-border-subtle text-center">
...
function TerpenePanel({ coa }: { coa: CoaRecord }) {
 ...
 <span
 key={i}
 className="text-xs text-white/50 bg-cult-surface border border-cult-border-subtle px-3 py-1.5 rounded-lg"
 >
...
function CoaActions({
 ...
 disabled={advancing}
 className={`w-full flex items-center justify-between gap-2 ${colors.bg} ${colors.hover} border border-cult-border-subtle rounded-cult p-3 transition-all active:scale-[0.98] disabled:opacity-50`}
 >
