...
export function StrainDrawer({ strainId, onClose, onBatchClick }: StrainDrawerProps) {
 ...
 className="w-full flex items-center gap-3 bg-cult-surface-subtle rounded-cult p-3 border border-cult-border-subtle hover:bg-cult-surface-raised hover:border-cult-border transition-all active:scale-[0.995] group"
 >
