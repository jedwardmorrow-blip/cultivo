...
export function SkuDrawer({ productId, onClose, onBatchClick }: SkuDrawerProps) {
 ...
 <div className="h-32 rounded-cult bg-cult-surface animate-pulse" />
 </div>
 ) : sku ? (
 <>
 {/* KPIs */}
 ...
 {/* Price */}
 <div className="bg-cult-surface rounded-cult p-3 border border-cult-border-subtle flex items-center justify-between">
 ...
 {packages.length === 0 ? (
 <div className="rounded-cult bg-cult-surface-inset border border-cult-border-faint p-6 text-center mt-2">
...
function PackageRow({
 ...
 className="flex items-center gap-3 bg-cult-surface-subtle rounded-cult p-3 border border-cult-border-subtle"
 >
