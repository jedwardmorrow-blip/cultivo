...
export function OfflineBanner() {
  ...
  // Offline
  return (
    <div className="bg-cult-warning-muted border-b border-cult-warning px-3 py-2 flex items-center gap-2 text-cult-warning text-xs font-medium">
      <WifiOff className="w-3.5 h-3.5 flex-shrink-0" />
      <span className="flex-1">
        You're offline — tasks will sync when connection returns
      </span>
      {pendingMutations > 0 && (
        <span className="flex items-center gap-1 text-cult-warning/80 flex-shrink-0">
