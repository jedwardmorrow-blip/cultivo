...
export function WorkerLayout({ children }: WorkerLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-cult-black flex flex-col">
      {/* Header */}
      <header className="bg-cult-near-black border-b border-cult-dark-gray px-4 py-3 flex items-center justify-between flex-shrink-0">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-cult-medium-gray text-[10px] uppercase tracking-wider">
        ...
        <button
          onClick={logout}
          className="flex items-center gap-1.5 text-cult-medium-gray hover:text-cult-white transition-colors text-xs uppercase tracking-wider"
        >
