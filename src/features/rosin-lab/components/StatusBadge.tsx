...
const DEFAULT_COLOR_MAP: Record<string, string> = {
  ...
  sold: 'bg-cult-success-muted text-cult-success border-cult-success/20',
  in_progress: 'bg-blue-500/10 text-blue-400 border-blue-500/20',
  completed: 'bg-cult-success-muted text-cult-success border-cult-success/20',
  failed: 'bg-cult-danger-muted text-cult-danger border-cult-danger/20',
  ...
  cured: 'bg-cult-success-muted text-cult-success border-cult-success/20',
