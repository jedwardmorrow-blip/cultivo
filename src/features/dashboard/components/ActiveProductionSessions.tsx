...
export function ActiveProductionSessions() {
  ...
  if (loading) {
    return <div className="text-cult-light-gray">Loading production sessions...</div>;
  }
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div className="bg-cult-black p-4 border border-cult-medium-gray">
          <p className="text-cult-light-gray text-sm uppercase tracking-wider">Packaging Sessions</p>
          <p className="text-3xl font-bold text-cult-white mt-2">{packagingSessions}</p>
        </div>
      </div>
    </div>
  );
