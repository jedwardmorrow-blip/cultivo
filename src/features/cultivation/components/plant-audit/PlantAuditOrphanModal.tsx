...
export function PlantAuditOrphanModal({
 ...
 <div className="bg-cult-surface rounded-cult max-w-lg w-full max-h-[90vh] overflow-y-auto border border-cult-border">
 ...
 <div className="bg-cult-surface-inset border border-cult-border-subtle rounded p-3 text-xs text-cult-text-secondary">
 ...
 disabled={!canSave}
 className="px-5 py-2 rounded border border-cult-accent text-cult-accent flex items-center gap-2 hover:bg-cult-accent hover:text-cult-opaque-black transition-colors disabled:opacity-40 disabled:cursor-not-allowed font-mono uppercase tracking-[0.16em] text-[11px]"
 >
