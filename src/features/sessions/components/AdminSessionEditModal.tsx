    ...
    <div className="fixed inset-0 bg-black/90 flex items-center justify-center z-50 p-4">
      <div className="bg-cult-surface border border-cult-border max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between p-6 border-b border-cult-border">
          <h2 className="text-2xl font-bold text-cult-text-primary uppercase tracking-wide">Edit Session</h2>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          <div className="bg-cult-surface p-4 rounded-lg border border-cult-border">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm">
              <div>
                <p className="text-cult-text-muted font-medium">Strain</p>
                <p className="font-bold text-cult-text-primary">{session.strain}</p>
              </div>
              <div>
                <p className="text-cult-text-muted font-medium">Batch</p>
                <p className="font-bold text-cult-text-primary font-mono">{session.batch_id}</p>
              </div>
              <div>
                <p className="text-cult-text-muted font-medium">Date</p>
          ...
          <div>
            <label className="block text-sm font-medium text-cult-text-primary mb-1">Trimmer Name</label>
            <input
              type="text"
              value={form.trimmer_name}
              onChange={(e) => handleChange('trimmer_name', e.target.value)}
              disabled={isBlocked}
              className="w-full px-3 py-2 bg-cult-black border border-cult-surface-raised rounded-cult text-cult-text-primary focus:outline-none focus:ring-2 focus:ring-cult-danger/50 focus:border-cult-danger transition-all disabled:opacity-50"
            />
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm font-medium text-cult-text-primary mb-1">Minutes Trimmed</label>
              <input
                type="number"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-cult-text-primary mb-1">Flower / Big Buds (g)</label>
              <input
                type="number"
                step="0.1"
            ...
            <div>
              <label className="block text-sm font-medium text-cult-text-primary mb-1">Smalls (g)</label>
              <input
                type="number"
                step="0.1"
            ...
            <div>
              <label className="block text-sm font-medium text-cult-text-primary mb-1">Bucked Smalls (g)</label>
              <input
                type="number"
                step="0.1"
          ...
          <div className="bg-cult-surface p-4 rounded-lg border border-cult-border space-y-2">
            <div className="flex justify-between text-sm">
              <span className="text-cult-text-muted">Total Output</span>
              <span className="font-bold text-cult-text-primary">{totalOutput.toFixed(1)}g</span>
            </div>
            <div className="flex justify-between text-sm">
              <span className="text-cult-text-muted">Variance</span>
              <span className={`font-bold ${Math.abs(variance) > 0.5 ? 'text-cult-warning' : 'text-cult-text-primary'}`}>
            ...
            <div className="flex justify-between text-sm border-t border-cult-border pt-2 mt-2">
              <span className="text-cult-text-muted">Grams/Hour</span>
              <span className="font-bold text-cult-text-primary">{gramsPerHour.toFixed(1)}</span>
            </div>
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              disabled={isBlocked}
              rows={2}
              className="w-full px-3 py-2 bg-cult-black border border-cult-surface-raised rounded-cult text-cult-text-primary placeholder-cult-text-secondary focus:outline-none focus:ring-2 focus:ring-cult-danger/50 focus:border-cult-danger transition-all disabled:opacity-50"
          ...
          <div className="flex gap-3 pt-2">
            <button
              ...
              className="flex items-center gap-2 px-6 py-2.5 bg-cult-accent text-cult-opaque-black hover:bg-cult-accent-hover transition-all font-semibold uppercase tracking-wider text-sm disabled:opacity-40 disabled:cursor-not-allowed"
            >
