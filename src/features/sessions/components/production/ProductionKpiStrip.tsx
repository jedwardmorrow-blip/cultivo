  ...
  return (
    <motion.div variants={staggerItem}>
      <Wrapper
        ...
        onClick={onClick}
        className={`${GLASS} p-4 flex items-center gap-3 w-full text-left relative overflow-hidden ${
          onClick ? 'cursor-pointer hover:bg-cult-surface-active hover:border-cult-border-strong transition-colors active:scale-[0.98]' : ''
        }`}
      >
        {/* Ambient glow */}
        {accent && (
