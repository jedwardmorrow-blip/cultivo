...
export function BuckingSessionCompleteModal({
 ...
 <div className="sticky top-0 glass-modal border-b border-cult-border px-6 py-4 rounded-t-cult">
 ...
 <div className="bg-cult-surface-raised p-4 rounded-cult border border-cult-border">
 ...
 <div className="flex gap-3 justify-end pt-4 border-t border-cult-border">
 <button
 type="button"
 onClick={onCancel}
 disabled={submitting}
 ...
 type="submit"
 disabled={submitting}
 className="px-6 py-2 border border-cult-accent text-cult-accent hover:bg-cult-accent hover:text-cult-opaque-black rounded font-mono uppercase tracking-[0.16em] text-[11px] transition-colors disabled:opacity-50"
 >
