...
export function SessionsUnified() {
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-3xl font-bold text-cult-text-primary">All Sessions</h1>
        <p className="text-cult-text-secondary mt-1">Overview of all active and completed production sessions</p>
      </div>
