        ...
        <table className="w-full">
          <thead className="bg-cult-surface border-b border-cult-border">
            <tr>
              ...
              <th className="px-4 py-3 text-right text-xs font-medium text-cult-text-secondary uppercase tracking-wider">3.5g</th>
              <th className="px-4 py-3 text-right text-xs font-medium text-cult-text-secondary uppercase tracking-wider">14g</th>
              <th className="px-4 py-3 text-right text-xs font-medium text-cult-text-secondary uppercase tracking-wider">454g</th>
              <th className="px-4 py-3 text-right text-xs font-medium text-cult-text-secondary uppercase tracking-wider">Minutes</th>
              <th className="px-4 py-3 text-right text-xs font-medium text-cult-text-secondary uppercase tracking-wider">Units/hr</th>
          ...
          <tbody className="divide-y divide-cult-border">
            {sessions.map((session) => {
              ...
              <tr key={session.id} className="hover:bg-cult-surface/50 transition-colors">
                ...
                <td className="px-4 py-3 text-sm text-right text-cult-text-primary">{session.units_3_5g || 0}</td>
                <td className="px-4 py-3 text-sm text-right text-cult-text-primary">{session.units_14g || 0}</td>
                <td className="px-4 py-3 text-sm text-right text-cult-text-primary">{session.units_454g || 0}</td>
                <td className="px-4 py-3 text-sm text-right text-cult-text-primary">{session.minutes_packaged != null ? session.minutes_packaged.toFixed(0) : '-'}</td>
                <td className="px-4 py-3 text-sm text-right font-medium text-cult-text-primary">{session.units_per_hour != null ? session.units_per_hour.toFixed(1) : '-'}</td>
                {isAdmin && (
                  <td className="px-4 py-3 text-sm">
