...
export function PackagingSessionCancelModal({
 ...
 <button
 onClick={onCancel}
 className="flex-1 border border-cult-border-strong text-cult-text-primary px-6 py-3 rounded-cult font-semibold uppercase tracking-wider hover:bg-cult-surface-raised hover:border-cult-border-strong transition"
 >
 Keep Session
 </button>
 </div>
