...
export function TrimSessionCompleteModal({
 ...
 >
 <div className="p-6">
 <h2 className="text-2xl font-bold mb-4 text-cult-text-primary uppercase tracking-wide">Complete Trim Session</h2>

 <div className="bg-cult-surface-raised p-4 rounded-cult mb-6 border border-cult-border">
 <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
 <div>
 <p className="text-cult-text-muted font-medium">Trimmer:</p>
 ...
 <div>
 <p className="text-cult-text-muted font-medium">Pulled Weight:</p>
 <p className="font-bold text-cult-text-primary">{session.pulled_weight}g</p>
 </div>
 <div>
 <p className="text-cult-text-muted font-medium">Time Elapsed:</p>
 ...
 <div>
 <label className="block text-sm font-medium text-cult-text-primary mb-1">Big Buds / Flower (g)</label>
 <input
 type="number"
 step="0.1"
 ...
 <div>
 <label className="block text-sm font-medium text-cult-text-primary mb-1">Small Buds (g)</label>
 <input
 type="number"
 step="0.1"
 ...
 />
 <p className="text-xs text-cult-text-muted mt-1">Smalls set aside for machine trimming</p>
 </div>
 </div>

 <div className="bg-cult-surface-raised p-3 rounded-cult border border-cult-border">
 <p className="text-sm text-cult-text-muted font-medium">Total Output:</p>
 <p className="text-xl font-bold text-cult-text-primary">{totalOutput.toFixed(1)}g</p>
 <p className="text-sm text-cult-text-muted font-medium mt-1">
 ...
 <p className="text-xs text-cult-text-muted mt-1">Where untrimmed smalls will be stored</p>
 </div>
 )}
 ...
 type="button"
 onClick={onCancel}
 className="border border-cult-border text-cult-text-primary px-6 py-2 font-semibold uppercase tracking-wider hover:border-cult-accent transition"
 >
 Cancel
 </button>
 </div>
