  ...
  return (
    <div className="flex items-center justify-between gap-3 flex-wrap">
      <div className="flex items-center gap-1.5 flex-wrap">
        <span className="text-[9px] font-bold text-neutral-600 tracking-[0.08em] mr-1">HEALTH</span>
        {HEALTH_OPTIONS.map(h => {
          ...
          return (
            <button
              ...
              className={`px-2 py-[3px] rounded-md text-[10px] font-semibold border transition-all duration-150 capitalize ${
                active
                  ? hs
        ...
        <span className="text-[9px] font-bold text-neutral-600 tracking-[0.08em] mr-1">GRADE</span>
        {GRADE_OPTIONS.map(g => {
          ...
          return (
            <button
              ...
              className={`px-2 py-[3px] rounded-md text-[10px] font-semibold border transition-all duration-150 ${
                active
                  ? gs
      ...
      <div className="flex items-center gap-2">
        <span className="text-[9px] font-bold text-neutral-600 tracking-[0.08em]">SORT</span>
        <select
          value={sortMode}
          onChange={e => setSortMode(e.target.value as SortMode)}
          className="text-[10px] font-semibold rounded-md px-2 py-[3px] border cursor-pointer outline-none bg-cult-black text-neutral-400 border-cult-medium-gray/40"
        >
