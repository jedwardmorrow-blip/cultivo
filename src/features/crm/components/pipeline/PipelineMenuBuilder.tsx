...
export function PipelineMenuBuilder({ strains, onClose }: MenuBuilderProps) {
 ...
 <div className="fixed z-[1000] flex flex-col rounded-cult border border-cult-border/40 overflow-hidden bg-[#0c0c0c] top-[6vh] left-1/2 -translate-x-1/2 w-[95vw] max-w-[1020px]"
 style={{ maxHeight: '88vh' }}
 >
 <div className="flex items-center justify-between px-5 py-3 border-b border-cult-border/30 flex-shrink-0">
 <div>
 ...
 <div className="flex flex-col border-r border-cult-border/30 flex-shrink-0 w-[270px] bg-[#0a0a0a]">
 <div className="p-3 border-b border-cult-border/20">
 ...
 className="w-full rounded-lg border border-cult-border/30 bg-cult-black pl-8 pr-3 py-1.5 text-xs text-white outline-none focus:border-cult-success/50 transition-colors"
 />
 </div>
 ...
 className={`flex items-center gap-2 px-3 py-[7px] border-b border-cult-border/10 transition-colors duration-150 ${
 ...
 <div className="px-3 py-2 text-xs text-neutral-700 border-t border-cult-border/20 font-semibold">
 ...
 <div key={item.strain} className="mb-3 rounded-cult border border-cult-border/20 overflow-hidden bg-cult-black">
 ...
 <div className="flex justify-between items-center px-[18px] py-3 border-t border-cult-border/30 flex-shrink-0 bg-[#0c0c0c]">
