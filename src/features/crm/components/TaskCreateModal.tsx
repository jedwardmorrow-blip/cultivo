    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
      <div className="bg-cult-surface border border-cult-border rounded-lg w-full max-w-md mx-4">
        <div className="px-5 py-4 border-b border-cult-surface-raised flex items-center justify-between">
          <h3 className="text-lg font-semibold text-cult-text-primary">New Task</h3>
        ...
        <div className="px-5 py-4 space-y-3">
          ...
          <div>
            <label className="block text-xs font-medium text-cult-text-secondary mb-1">Title *</label>
            <input
              type="text"
              value={form.title}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <div>
              <label className="block text-xs font-medium text-cult-text-secondary mb-1">Priority</label>
              <select
                value={form.priority}
          ...
          <div>
            <label className="block text-xs font-medium text-cult-text-secondary mb-1">Due Date</label>
            <input
              type="date"
              value={form.due_date}
          ...
          <div>
            <label className="block text-xs font-medium text-cult-text-secondary mb-1">Description</label>
            <textarea
