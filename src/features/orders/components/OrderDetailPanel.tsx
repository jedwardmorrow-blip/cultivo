            ...
            <div className="flex items-center gap-2">
              {prevStatus && (
                <button
                  ...
                  disabled={!!updating}
                  className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2.5 border border-cult-border text-cult-text-secondary hover:text-cult-text-primary hover:border-cult-border-strong text-xs font-semibold rounded-cult transition-all disabled:opacity-40"
                >
              ...
              {!isCompleted && (
                <button
                  ...
                  disabled={!!updating}
                  className="flex items-center justify-center gap-1 px-3 py-2.5 text-cult-danger hover:text-cult-danger/80 text-xs font-semibold transition-all disabled:opacity-40"
                >
      ...
      <div className="fixed top-0 right-0 h-full w-full max-w-4xl bg-cult-surface border-l border-cult-border z-50 flex flex-col animate-slide-in-right">
        ...
        <div className="flex-shrink-0 px-4 lg:px-6 py-4 border-b border-cult-border bg-cult-surface-raised">
          <div className="flex items-center justify-between mb-4">
            ...
            <button onClick={onClose} className="p-2.5 text-cult-text-secondary hover:text-cult-text-primary hover:bg-cult-surface-overlay rounded-cult transition-colors">
              <X className="w-5 h-5" />
            </button>
          </div>
        ...
        <div className="flex-1 overflow-y-auto">
          <div className="flex flex-col lg:flex-row min-h-full">
            ...
            <div className="w-full lg:w-80 lg:flex-shrink-0 border-b lg:border-b-0 lg:border-r border-cult-border p-4 lg:p-5 space-y-5 bg-cult-surface-raised/50">
        ...
        {/* ─── Footer ────────────────────────────────────────────────── */}
        <div className="flex-shrink-0 px-4 lg:px-6 py-3 border-t border-cult-border bg-cult-surface-raised flex items-center gap-2">
          <button
            onClick={() => onCloneOrder(order)}
            className="flex items-center gap-1.5 px-3 py-2.5 text-xs font-semibold text-cult-text-secondary hover:text-cult-text-primary bg-cult-surface-overlay hover:bg-cult-border-strong rounded-cult transition-all uppercase tracking-wider"
          >
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-2.5 text-xs font-semibold text-cult-danger hover:text-cult-danger/80 bg-cult-danger/10 hover:bg-cult-danger/15 border border-cult-danger/20 rounded-cult transition-all uppercase tracking-wider ml-auto"
          >
