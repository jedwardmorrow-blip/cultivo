  ...
  const statusPills: StatusPill[] = [
    {
      ...
      colors: 'text-cult-danger border-cult-danger/50 bg-cult-danger-muted',
      activeColors: 'text-cult-danger border-cult-danger bg-cult-danger-muted',
    },
    {
      key: 'all',
      label: 'All',
    ...
    },
    {
      ...
      colors: 'text-cult-info/70 border-cult-info/30 bg-cult-info-muted/50',
      activeColors: 'text-cult-info border-cult-info bg-cult-info-muted',
    },
    {
      key: 'accepted',
      label: 'Accepted',
    ...
    },
    {
      ...
      colors: 'text-cult-warning/70 border-cult-warning/30 bg-cult-warning-muted/50',
      activeColors: 'text-cult-warning border-cult-warning bg-cult-warning-muted',
    },
    {
      key: 'ready_for_delivery',
      label: 'Ready',
      count: statusCounts.ready_for_delivery,
      colors: 'text-cult-success/70 border-cult-success/30 bg-cult-success-muted/50',
      activeColors: 'text-cult-success border-cult-success bg-cult-success-muted',
    },
    {
      key: 'completed',
      label: 'Completed',
      count: statusCounts.completed,
      colors: 'text-cult-success-bright/70 border-cult-success/30 bg-cult-success-muted/50',
      activeColors: 'text-cult-success-bright border-cult-success bg-cult-success-muted',
    },
    {
      key: 'cancelled',
      label: 'Cancelled',
      count: statusCounts.cancelled,
      colors: 'text-cult-danger/70 border-cult-danger/30 bg-cult-danger-muted/50',
      activeColors: 'text-cult-danger border-cult-danger bg-cult-danger-muted',
    },
  ];
