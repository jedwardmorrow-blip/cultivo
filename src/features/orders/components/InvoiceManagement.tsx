...
export function InvoiceManagement() {
  ...
  function getStatusColor(status: string) {
    const colors: Record<string, string> = {
      ...
      sent: 'bg-cult-info-muted text-cult-info border-cult-info',
      paid: 'bg-cult-success-muted text-cult-success border-cult-success',
      overdue: 'bg-cult-danger-muted text-cult-danger border-cult-danger',
    ...
    <div className="space-y-6">
      ...
      {pendingInvoices.length > 0 && (
        <div className="bg-cult-warning-muted border border-cult-warning/30 rounded-lg p-4">
          <h3 className="text-lg font-semibold text-cult-warning mb-3 flex items-center gap-2">
