...
export const sectionDefinitions: SectionDefinition[] = [
   ...
   */
  {
    ...
    items: [
      ...
      { id: 'cultivation-schedules', label: 'Schedule', icon: CalendarDays, group: 'secondary' },
      { id: 'worker-tasks', label: 'Crew', icon: Users, group: 'secondary' },
      { id: 'cultivation-digest', label: 'Reports', icon: FileText, group: 'secondary' },
      { id: 'cultivation-analytics', label: 'Analytics', icon: BarChart3, group: 'secondary' },
    ],
  },
  {
    id: 'production',
