...
6. Design system bible (DS v7, current canonical): /Users/justinmorrow/Desktop/Claude/_inbound/cultivo-ds-7-2026-04-26/CLAUDE.md — supersedes the v5 CLAUDE.md. Pay particular attention to the "Three surface treatments" section (A Hairline grid, B Gapped cards, C Hybrid) and the "Migration context" section.
7. Phase 1 surface guide (DS v7, load-bearing for THIS session): /Users/justinmorrow/Desktop/Claude/_inbound/cultivo-ds-7-2026-04-26/phase-0-rebrand/PHASE-1-SURFACE-GUIDE.md — defines which treatment applies per surface region. The Distribution brief includes a per-region treatment map derived from this guide; read this guide first to understand the doctrine, then check the brief's map. The marquee call: the calendar is hairline, NOT bento-of-cards.
8. Typed token contract: /Users/justinmorrow/Desktop/Claude/_inbound/cultivo-ds-7-2026-04-26/ui_kits/cult-ops-brand/brand-tokens.css — byte-identical to the v5 file; tokens did not move in v7.
9. System Reference, full file: /Users/justinmorrow/Desktop/Claude/_inbound/cultivo-ds-7-2026-04-26/ui_kits/cult-ops-brand/Cultivo · System Reference.html — pay particular attention to section 04 (atoms), section 05 (molecules including KPI strip and Room Roll Strip), section 09 (violation lint), section 10 (bento grid policy and construction rules), and the new surface-treatments section.
10. Existing cult-ops Distribution code copied for visual reference (do not port styles, just understand the surface): /Users/justinmorrow/Desktop/Claude/_inbound/cultivo-app-ref-2026-04-26/reference/DistributionCommandCenter.tsx, DistributionKpiStrip.tsx, distribution-constants.ts
